...
{
    public static async Task<TInteractionResult> HandleNextInteraction<TInteractionResult>(
        this InteractivityExtension interactivity, IList<InteractivityHandler<TInteractionResult>> handlers)
    {
        ...
        var handlerAbstractions =
            handlers.Select<InteractivityHandler<TInteractionResult>, Func<Task<TInteractionResult>>>(handler =>
                async () =>
                {

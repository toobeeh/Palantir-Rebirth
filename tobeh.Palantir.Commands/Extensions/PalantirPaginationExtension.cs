...
public static class PalantirPaginationExtension
{
        ...
        List<DiscordEmbedBuilder> pages, string pageListingName = "Page", int? startPage = null)
    {
        ...
        DiscordComponentEmoji nextPageEmoji = new DiscordComponentEmoji
            { Id = 1217564955729985586, Name = "tt_award_stonks" };
        DiscordComponentEmoji prevPageEmoji = new DiscordComponentEmoji
            { Id = 1218616453864099871, Name = "tt_award_notstonks" };
